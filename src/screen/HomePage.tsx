...
export default function HomePage() {
    ...
    // ✅ FIX FOR MESSENGER / TELEGRAM BROWSER HEIGHT ISSUE
    useEffect(() => {
    ...
    return (
        ...
        <div
            className="min-h-[calc(var(--vh)*100)] w-screen flex justify-center items-center overflow-hidden"
            style={{
        ...
        >
            ...
            <div className='h-[calc(var(--vh)*100)] w-screen bg-transparent flex flex-col justify-center items-center'>
                ...
                <div className='relative flex flex-col w-[80%] h-[30%] bg-amber-100 rounded-2xl justify-center items-center md:w-[400px] md:h-[300px] md:bg-amber-100 md:flex md:flex-col md:justify-center md:items-center'>
                    ...
                    <div className='flex flex-row items-center gap-[5px] md:gap-[10px] w-[70%] justify-center'>
                        ...
                        <button
                            className='ml-[20px] bg-black py-[5px] px-[10px] rounded-lg'
                            onClick={copyNumber}
                        >
                            <h1 className='text-[13px] md:text-[15px] font-[poppins] font-medium text-white'>
                                {state ? 'Copied' : 'Copy'}
                            </h1>
                        </button>
...

                {
                    !press && (
                        <button
                            className='bg-cyan-900 py-[10px] px-[20px] rounded-full mt-[30px] animate-bounce'
                            onClick={handleButtonClick}
                        >
                            <h1 className='text-[16px] text-white font-[poppins] font-bold'>
                                ভিতরে কী আছে জানতে বক্সটি খুলুন 👀🎁
                            </h1>
                        </button>
                    )
                }
